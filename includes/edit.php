<?php
			...
			$insert = insert('comments',$data);
			flash( 'info', 'Congratulations, You Replied to the thread');	
...
<br><br>
<form action="newpost.php?id=<?php echo $_GET['id'];?>&c=<?php echo $_GET['c']; ?>&cid=<?php echo $_GET['id'];?>" enctype="multipart/form-data" method="POST">
